...
if(!isset($_GET['action'])) {
  if(!empty($_SESSION['user_id'])) {
    ...
    echo '<p><a href="https://developers.google.com/identity/protocols/oauth2" target="_blank">Using OAuth 2.0 to Access Google APIs</a></p>';
    echo '<p><a href="https://developers.google.com/identity/protocols/oauth2/web-server" target="_blank">Using OAuth 2.0 for Web Server Applications</a></p>';
    echo '<p><a href="https://developers.google.com/identity/protocols/oauth2/scopes" target="_blank">OAuth 2.0 Scopes for Google APIs</a></p>';
    echo '</div>';
